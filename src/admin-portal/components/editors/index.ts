...
export type EditorId = typeof editorConfig[number]['id'] | 'servicesPage' | 'notFoundPage' | 'faqSection' | 'contactPage' | 'privacyPolicyPage' | 'termsPage' | 'warrantyPolicyPage';
...
export type PagePreviewId = 'servicesPage' | 'notFoundPage' | 'contactPage' | 'privacyPolicyPage' | 'termsPage' | 'warrantyPolicyPage';
...
export const isDynamicPagePreview = (id: EditorId): boolean => {
  return id === 'servicesPage' || id === 'notFoundPage' || id === 'faqSection' || id === 'contactPage' || id === 'privacyPolicyPage' || id === 'termsPage' || id === 'warrantyPolicyPage';
};
